...
import (
	...
	"github.com/jbrekelmans/go-module-proxy/cmd/clientforwardproxy"
	"github.com/jbrekelmans/go-module-proxy/cmd/credentialhelper"
	"github.com/jbrekelmans/go-module-proxy/cmd/server"
)
